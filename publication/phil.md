...
Suppose we want to build a universe from as little as possible. Not a universe like ours specifically — just any universe at all. A universe in the thinnest sense: a self-consistent structure of relations that gives rise to something rather than nothing.

What must such a structure contain?
...
Before anything else, there must be the capacity for self-relation. Something must be able to be the same as itself. This is not a thing — it is a relational mode. It says: persistence is possible. Sameness is available as a concept.

Without identity, nothing is anything. There are no stable referents, no continuity, no "this" as distinct from "that." Identity is not interesting on its own — it is the precondition for anything interesting being possible.

We assign this concept the symbol 1.
...
So far we have four relational concepts: identity (1), opposition (−1), otherness (*i*), and conjugate otherness (−*i*). But we have not yet demanded that they do anything together.
...
Consider: what does otherness composed with itself produce? There are four possibilities — 1, −1, *i*, or −*i* — and not all are consistent with the concepts we have established.

If *i* · *i* = 1, then otherness is its own inverse. But we have just argued that the defining structural feature of otherness is that it is *not* self-inverse. An element that squares to the identity is a form of opposition — it cancels itself, it resolves. This would collapse otherness back into the same structural category as −1, destroying the distinction we established.

If *i* · *i* = *i*, then otherness is idempotent. Repeated composition of otherness never yields a new relational mode, so the structure cannot distinguish accumulation from repetition. This collapses the productive role assigned to composition.

This leaves two candidates: *i* · *i* = −1 and *i* · *i* = −*i*. But the latter is incompatible with group structure. Since −*i* denotes the opposition of *i* — that is, (−1) · *i* — the equation *i* · *i* = −*i* means
...
## 4. What is a universe, then?

We have argued that any minimally expressive relational structure requires identity, opposition, and irreducible otherness, and that these must compose. The minimal algebraic structure satisfying these conditions is Z₄.

But a universe is not a group. It is a *structure built from the group's relations*. How?
...
The opening movement of Hegel's *Science of Logic* begins from almost exactly where we begin. Pure Being — completely indeterminate, without any content — turns out to be indistinguishable from Nothing. The two pass into each other immediately, and this passage is Becoming.

The correspondence to our first two concepts is striking. Identity (Being as pure, contentless self-sameness) and opposition (Nothing as the maximal negation of Being) are Hegel's starting point. And Becoming — the passage from one to the other — resonates with our claim that the primitive act of a universe is directed transition.

But we part company with Hegel at a crucial point. For Hegel, Becoming is a *synthesis* — it sublates Being and Nothing into a higher unity, which then becomes the thesis for a new triad, and so on, spiralling upward without limit. The dialectic totalises. Every opposition is eventually resolved.

Our structure does not do this. Otherness (*i* and −*i*) is not a synthesis of identity and opposition. It is a genuinely new relational mode that is irreducible to either. The *i* elements of Z₄ are never sublated into 1 or −1. They remain permanent, distinct, unresolved. Our algebra closes — four elements, not an infinite spiral — and within that closure, otherness persists.

If Hegel's dialectic is an open spiral, Z₄ is a closed circle. The question is whether the universe spirals or closes. We suggest it closes.

### 5.2 Levinas: irreducible alterity

Emmanuel Levinas built an entire philosophy on the claim that otherness is irreducible. The Other — the other person, in his formulation — cannot be absorbed into the categories of the self. The Other is not my negation, not my mirror, not anything I can comprehend or contain. The encounter with the Other is not cognitive but ethical: it places a demand on me before I can understand it.

Three features of Levinas's account map directly onto our structure.

First, *irreducibility*. For Levinas, the Other is not reducible to the Same. The relation of alterity is not a species of identity or opposition — it is genuinely distinct from both. This is precisely our claim about *i*: it is not 1, not −1, and not derivable from them.

Second, *asymmetry*. Levinas insists that the relation to the Other is not reciprocal. The Other is *above* me — the relation is directed, not symmetric. Our edges are directed. The relation a → b is not the same as b → a. Asymmetry is built in at the most primitive level.

Third, *obligation*. For Levinas, the encounter with the Other places an inescapable demand on the self — a responsibility that precedes choice. Our conservation law has a similar structure. What arrives at a node constrains what can depart. The incoming edges *obligate* the node to respond consistently. This is not a chosen response; it is an algebraic necessity.

Levinas, of course, was talking about ethics between persons, not algebra between edges. We do not claim he was doing group theory. We claim that the structural features he identified — irreducibility, asymmetry, obligation — are signatures of a deeper relational architecture that appears wherever the concept of otherness is taken seriously.

### 5.3 Peirce: firstness, secondness, thirdness

Charles Sanders Peirce divided all experience into three universal categories. Firstness is pure quality — something simply being what it is, without reference to anything else. Secondness is reaction — the brute encounter with something other, resistance, struggle. Thirdness is mediation — law, habit, the relation that brings first and second into intelligible connection.

The correspondence with our structure is suggestive. Identity has the character of firstness: self-sufficient, self-relating, requiring no reference beyond itself. Opposition has the character of secondness: brute encounter, the shock of the not-self. And the conservation law — the requirement that relations balance at every node — has the character of thirdness: the mediating principle that renders the network of brute encounters self-consistent.

Where, then, is otherness? In Peirce's system, it might seem to be absorbed into secondness — just another form of brute encounter. But Peirce explicitly denied that there was any irreducible fourthness. He argued that triadic relations are sufficient to generate all higher-order structure.

We respectfully disagree. Or rather, we suggest that what Peirce classified as a single category — secondness, the encounter with the other — in fact contains an internal distinction that he did not fully articulate. The encounter with the *opposite* (−1) and the encounter with the *genuinely other* (*i*) are structurally different events. The first is self-referential: opposition is defined by what it negates. The second is irreducibly creative: otherness introduces something that was not implicit in the original. Peirce's secondness conflates these, and the conjugate pair (*i*, −*i*) is what his system was missing.

That several thinkers have dedicated careers to arguing for an irreducible fourthness in Peirce's system lends some support to this reading.
...
This is remarkably close to what Hegel meant by Becoming. In the *Science of Logic*, Becoming is not a process that happens *to* Being and Nothing. It is the truth *of* Being and Nothing — the concept that reveals what they always already were. Being and Nothing, taken in isolation, are empty abstractions. Only in their passage into each other — only in Becoming — do they acquire content.

Similarly, in our framework, nodes taken in isolation are empty. A node with no edges is nothing — not even nothing, since Nothing itself would need to be related to Something to have meaning. Only through the edges — through the acts of becoming — do nodes acquire identity, character, phase.

The edge *is* the becoming. The Z₄ label *classifies* the becoming. And the universe *is* the totality of becomings, constrained only by the requirement that they not contradict each other.


## 7. Why this and nothing more

We have argued that three relational concepts are necessary for any minimally expressive universe: identity, opposition, and irreducible otherness. We have shown that the requirement of compositional closure forces these into Z₄. And we have hinted that this minimal structure may contain the seeds of a physics.

There is a natural objection. Why not a larger group? Why not Z₆, or Z₈, or a non-abelian group that could carry even richer structure?
...
It is worth being explicit about the different strengths of the claims we are making.
...
These three claims form a pipeline: concepts → algebra → physics. The present paper is concerned with the first arrow. The second is the subject of a separate, formal treatment.


## 9. Conclusion

We began by asking what must exist for anything to exist at all. The answer we arrived at is spare: three relational concepts, a compositional requirement, and a consistency constraint. The algebra that emerges — Z₄ — is derived from an analysis of what the concepts of identity, opposition, and otherness require when they are taken seriously as primitive and asked to compose consistently.
